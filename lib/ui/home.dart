...
import 'dart:async';
import 'package:jamtangan/ui/inputpenjualan.dart'; 
...
class _HomeState extends State<Home> {   
  ...
  //untuk menampung jumlah data
   ...
   Future<List> getData() async{     
     ...
     final response= await http.get('http://192.168.43.173/rest_api/index.php/penjualan/');     
      ...
      ListView createListView() {     
        ...
        Future<http.Response> deletePenjualan(id) async {    
          final http.Response response = await http.delete(     
            'http://192.168.43.173/rest_api/index.php/penjualan/delete/$id');   
            return response; }
